...
function Side() {
  return (
    <div className=" flex-1 w-[30%]">
      ...
      <div>
        <div className="flex items-center gap-4 pl-6 py-1  my-1 font-bold text-gray-700 rounded-r-full hover:bg-slate-400 ">
        ...
        <div className="flex items-center gap-4 pl-6 py-1 my-1 font-bold text-gray-700 rounded-r-full hover:bg-slate-400">
           <MdOutlineKeyboardArrowDown size={"20px"} ></MdOutlineKeyboardArrowDown>
            <p>More</p>
        </div>
